...
export interface MasteringParameterDefinition {
  ...
  dsp?: "lowShelf" | "midPeak" | "highShelf" | "highPass" | "compressor" | "output" | "worklet";
  backend: string;
}

export const masteringParameters: readonly MasteringParameterDefinition[] = [
  { id: "eqLowGainDb", labelKey: "eqLow", min: -6, max: 6, defaultValue: 0, step: .5, unit: "dB", category: "live", dsp: "lowShelf", backend: "eq_low_gain_db" },
  { id: "eqMidGainDb", labelKey: "eqMid", min: -6, max: 6, defaultValue: 0, step: .5, unit: "dB", category: "live", dsp: "midPeak", backend: "eq_mid_gain_db" },
  { id: "eqHighGainDb", labelKey: "eqHigh", min: -6, max: 6, defaultValue: 0, step: .5, unit: "dB", category: "live", dsp: "highShelf", backend: "eq_high_gain_db" },
  ...
  { id: "dynamicEqReductionDb", labelKey: "dynamicEq", min: 0, max: 12, defaultValue: 0, step: .5, unit: "dB", category: "approximate", dsp: "compressor", backend: "dynamic_eq_reduction_db" },
  { id: "bassControlReductionDb", labelKey: "bassControl", min: 0, max: 12, defaultValue: 0, step: .5, unit: "dB", category: "approximate", dsp: "compressor", backend: "bass_control_reduction_db" },
  { id: "deEsserReductionDb", labelKey: "deEsser", min: 0, max: 12, defaultValue: 0, step: .5, unit: "dB", category: "approximate", dsp: "compressor", backend: "de_esser_reduction_db" },
